    ...
    return (
      <div className="body">
        ...
        <div className="about_us_container">
          ...
          <p className="about_us_body">
            I have always had a love for music. I learned to play piano from my
            grandmother growing up, but was always shy about being in the
            spotlight with music. I still remember when Andrew and I were first
            married I wouldn’t sing in front of him. He slowly chipped away and
            has really encouraged me to share what I have worked for.
            ...
            became very mellow. It is the tool that changed my life. From Us: We
            really appreciate those who listen to our music and support us in
            our desire to share uplifting music.
          </p>
        </div>
      </div>
    );
